...
<div className="mt-4">
  <div className="text-left text-md font-normal text-indigo-200/65">
  <h1 className="text-4xl my-14">Terms of service</h1>
<p className="mb-4">Last updated: May 01, 2023</p>
<p className="mb-4">Please read these terms and conditions carefully before using Our Service.</p>
<h2 className="text-2xl my-6">Interpretation and Definitions</h2>
<h3 className="text-xl my-6">Interpretation</h3>
...
<h3 className="text-xl my-6">Definitions</h3>
...
<h2 className="text-2xl my-6">Links to Other Websites</h2>
...
<h2 className="text-2xl my-6">Termination</h2>
...
<h2 className="text-2xl my-6">Limitation of Liability</h2>
...
<h2 className="text-2xl my-6">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
...
<h2 className="text-2xl my-6">Governing Law</h2>
...
<h2 className="text-2xl my-6">Disputes Resolution</h2>
...
<h2 className="text-2xl my-6">For European Union (EU) Users</h2>
...
<h2 className="text-2xl my-6">United States Legal Compliance</h2>
<p className="mb-4">You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
<h2 className="text-2xl my-6">Severability and Waiver</h2>
<h3 className="text-xl my-6">Severability</h3>
...
<h3 className="text-xl my-6">Waiver</h3>
<p className="mb-4">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
<h2 className="text-2xl my-6">Translation Interpretation</h2>
<p className="mb-4">These Terms and Conditions may have been translated if We have made them available to You on our Service.
You agree that the original English text shall prevail in the case of a dispute.</p>
<h2 className="text-2xl my-6">Changes to These Terms and Conditions</h2>
