...
<div className="mt-4">
  ...
  <h1 className="text-4xl my-14">Privacy Policy</h1>
...
<li>
<p className="mb-4"><b>Account</b> means a unique account created for You to access our Service or parts of our Service.</p>
</li>
<li>
...
<li>
<p className="mb-4"><b>Cookies</b> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
</li>
<li>
...
<li>
<p className="mb-4"><b>Personal Data</b> is any information that relates to an identified or identifiable individual.</p>
</li>
<li>
<p className="mb-4"><b>Service</b> refers to the Website.</p>
</li>
<li>
<p className="mb-4"><b>Service Provider</b> means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.</p>
</li>
<li>
<p className="mb-4"><b>Usage Data</b> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
</li>
<li>
<p className="mb-4"><b>Website</b> refers to FlowIQ, accessible from <a href="https://flowiq.cc" rel="external nofollow noopener" target="_blank">https://flowiq.cc</a></p>
</li>
<li>
...
<h2 className="text-2xl my-6">Collecting and Using Your Personal Data</h2>
<h3 className="text-xl my-6">Types of Data Collected</h3>
<h4 className="text-lg my-6">Personal Data</h4>
...
<h4 className="text-lg my-6">Usage Data</h4>
...
<h4 className="text-lg my-6">Tracking Technologies and Cookies</h4>
...
<ul className="list-disc pl-4">
<li>
<p className="mb-4"><b>Necessary / Essential Cookies</b></p>
...
<li>
<p className="mb-4"><b>Cookies Policy / Notice Acceptance Cookies</b></p>
...
<li>
<p className="mb-4"><b>Functionality Cookies</b></p>
<p className="mb-4">Type: Persistent Cookies</p>
<p className="mb-4">Administered by: Us</p>
...
<h3 className="text-xl my-6">Use of Your Personal Data</h3>
<p className="mb-4">The Company may use Personal Data for the following purposes:</p>
<ul className="list-disc pl-4">
<li>
<p className="mb-4"><b>To provide and maintain our Service</b>, including to monitor the usage of our Service.</p>
</li>
<li>
<p className="mb-4"><b>To manage Your Account:</b> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</p>
</li>
<li>
<p className="mb-4"><b>For the performance of a contract:</b> the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.</p>
</li>
<li>
<p className="mb-4"><b>To contact You:</b> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</p>
</li>
<li>
<p className="mb-4"><b>To provide You</b> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</p>
</li>
<li>
<p className="mb-4"><b>To manage Your requests:</b> To attend and manage Your requests to Us.</p>
</li>
<li>
...
<li>
<p className="mb-4"><b>For other purposes</b>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</p>
</li>
</ul>
...
<h3 className="text-xl my-6">Retention of Your Personal Data</h3>
...
<h3 className="text-xl my-6">Transfer of Your Personal Data</h3>
...
<h3 className="text-xl my-6">Delete Your Personal Data</h3>
...
<h4 className="text-lg my-6">Other legal requirements</h4>
...
<h3 className="text-xl my-6">Security of Your Personal Data</h3>
<p className="mb-4">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
<h2 className="text-2xl my-6">Children's Privacy</h2>
...
<h2 className="text-2xl my-6">Changes to this Privacy Policy</h2>
