      ...
      <button
        ...
        onClick={() => {
          ...
          if (typeof window !== "undefined" && window.gtag) {
            window.gtag("event", "Intake Demo Video Click", {
...
<div className="fixed inset-0 z-[99999] flex px-4 py-6 sm:px-6">
  <div className="mx-auto flex h-full w-full max-w-6xl items-center">
    <DialogPanel
      transition
      className="w-full max-w-full overflow-hidden rounded-2xl bg-black shadow-2xl duration-300 ease-out data-closed:scale-95 data-closed:opacity-0"
    >
      <div className="aspect-video w-full">
        <iframe
          ref={videoRef as any}
          src={`${video}?modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&controls=1`}
